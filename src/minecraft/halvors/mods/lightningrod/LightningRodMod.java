...
public class LightningRodMod {

	// The instance of your mod that Forge uses.
	@Instance("LightningRod")
	public static LightningRodMod instance;
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		try {
			config.load();
			Property block = config.getBlock("lightningRod", 2679);
			block.comment = "The block id for the compact solar arrays.";
			blockLightningRod = new BlockLightningRod(block.getInt(2679));
